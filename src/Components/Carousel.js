        ...
        <Fragment>
            <Carousel activeIndex={index} onSelect={handleSelect} style={{ height: "500px" }}>
                <Carousel.Item style={{ height: "500px" }} className="w-100" >
                    <img alt="" src={img1}  style={{objectFit:"cover"}} className="w-100 h-100"/>
                </Carousel.Item>
                <Carousel.Item style={{ height: "500px" }} className="w-100">
                    <img alt="" src={img2}  style={{objectFit:"cover"}}  className="w-100 h-100"/>
                </Carousel.Item>
                <Carousel.Item style={{ height: "500px" }} className="w-100">
                    <img alt="" src={img3} style={{objectFit:"cover"}} className="w-100 h-100"/>
                </Carousel.Item>
            </Carousel>
        </Fragment>
    )
