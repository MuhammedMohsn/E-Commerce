...
function Cart() {
  ...
  return (
    <Fragment>
      <h1 className={`text-start mb-4 ps-4 ${styles.cart_header}`}>
        Shopping Cart
      </h1>
      <hr />
      <Row className="justify-content-between mb-5">
        ...
        <Col xs="12" md="5">
          <h3>Order Summary</h3>
          <div className=" ps-3 d-flex align-items-center justify-content-between">
            <p>Subtotal</p>
            <p>${parseInt(total)}</p>
          </div>
          <div className=" ps-3 d-flex align-items-center justify-content-between">
          ...
          <Button variant="primary" className="w-100 text-center rounded">
            Check Out
          </Button>
        </Col>
      </Row>
